...
const techStack = {
  viewSkillBars: false, // Set true to show Proficiency (StackProgress) section
  experience: [
    {
...
const blogSection = {
  ...
  display: false // Set true to show Blogs section
};
...
const talkSection = {
  ...
  display: false // Set true to show Talks section
};
...
const podcastSection = {
  ...
  display: false // Set true to show Podcast section
};
...
const twitterDetails = {
  ...
  display: false // Set true to show Twitter embed section
};
